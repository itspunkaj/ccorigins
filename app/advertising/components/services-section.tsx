        ...
        <div className="bg-white py-16 md:py-10">
            ...
            <div
                ...
                <div className="col-span-2 mb-8">
                    <p className="text-lg font-medium text-primaryYellow dark:text-primaryYellow">&ldquo;Your unfair advantage&rdquo;</p>
                    <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">
                        We turn brands into <span className="font-bold text-primaryYellow uppercase">obsessions.</span></h2>
                    ...
                    <div className="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
                        <div>
                            <a href="#"
                                className="inline-flex items-center text-base font-medium text-primaryYellow hover:text-purple-800 dark:text-primaryYellow dark:hover:text-purple-700">
                                Contact Us Now
