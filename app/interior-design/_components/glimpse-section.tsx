      ...
      <div className="max-w-8xl mx-auto py-20 px-4 ">
        ...
        <div className="grid md:grid-cols-2 justify-around gap-4">
          <div className="relative w-full rounded-lg overflow-hidden">
            <Image
              src="/images/apartment-before.jpg"
              className="w-full h-full object-cover"
              height={800}
              width={800}
              alt="before apartment"
            />
            <p className="absolute bottom-2 left-4 text-2xl">BEFORE</p>
          </div>
          <div className="relative w-full rounded-lg overflow-hidden">
            <Image
              ...
              alt="before apartment"
            />
            <p className="absolute bottom-2 left-4 text-2xl text-white">AFTER</p>
          </div>
        </div>
      </div>
    </section>
