            ...
            <div className="  h-full max-w-8xl mx-auto w-full grid md:grid-cols-2 gap-10 p-10 pb-0">
                <div className="flex flex-col md:justify-end">
                    <div className="flex flex-col mb-10">
                        ...
                        <p className="md:text-lg 2xl:text-2xl font-thin mt-1">
                            Step into spaces that inspire. From cozy corners to bold open plans,<br /> our interiors are designed to make you feel something - every single day.
                        </p>
                    </div>
                ...
                <div className="flex flex-col justify-end uppercase pb-8">
                    ...
                    <div className="my-4 flex flex-col text-5xl 2xl:text-7xl text-primaryYellow font-extrabold">
                        <span>Bungalow</span>
