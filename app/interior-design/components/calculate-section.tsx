                ...
                <div className="bg-transparent py-10">
                    <div className=" flex max-sm:flex-col items-center justify-center font-light">
                        <div className="w-1/3 px-2">
                            <Button className="w-full md:text-2xl 4xl:text-4xl py-6 normal-case font-light">Calculate</Button>
                        </div>
                ...
                <div className="bg-primaryYellow py-10">
                    <div className="flex items-center justify-center">
                        <div className="flex flex-col items-center justify-center w-full font-light">
                            <Button className="w-1/3 md:text-2xl 4xl:text-4xl py-6 text-white normal-case font-extralight" variant={"secondary"} onClick={() => {
