...
export default function Page({ params }: { params: Promise<{ step: string }> }) {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center bg-gray-100 pt-20">
                ...
                <div className="p-6 flex items-center justify-center flex-col">
                    ...
                    <h1 className="text-xl font-bold mb-4">{currentStep.title}</h1>
                    {
                        ...
                        <p className="">
                            ...
                            {currentStep.infolink && <span className="text-primaryYellow">&nbsp;{currentStep.infolink}</span>}
                        </p>
                    }
                    {
                        currentStep.component && <div>
                            {currentStep.component}
                        </div>
                    }
                </div>
                <div className="px-6 py-4 flex justify-between border-t">
                    <Button className="border-none flex items-center gap-1 font-thin" variant={"outline"} disabled={currentIndex === 0} // disable at first step
                    ...
                    </Button>
                    {
                        ...
                        <Button className="border-none font-thin"
                            onClick={() => goToStep(currentIndex + 1)}>
                            Next
                        </Button>
                    }
