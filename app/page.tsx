        ...
        <section className="h-[120dvh] bg-trasparent w-full flex flex-col">
            <div className="h-[80%] w-full">
                <div className="relative h-full w-full overflow-hidden">
                    ...
                    {/* Lamp Image */}
                    <Image src={"/images/new-homepage/PNG/Lamp.png"} height={400} width={200} alt="lamp" className="absolute top-0 right-1/2 z-40 translate-x-1/2 object-cover w-[300%] md:w-[45%] 4xl:w-[40%] " />
                    <div className="absolute bottom-0 h-1/2 w-full flex items-center justify-center flex-col ">
                        <div className="max-w-8xl text-yellow-50  w-full h-full flex flex-col items-center justify-center">
                            <div className="h-1/3 flex font-bahn flex-col items-center justify-start py-10">
                                <h1 className="4xl:text-7xl xl:text-5xl text-4xl font-thin tracking-widest">creative catalyst</h1>
                                <h2 className="text-lg xl:text-2xl 4xl:text-4xl capitalize">Defining Leadership 360 degree</h2>
                            </div>
                            <div className="flex-1 uppercase font-cinzel flex flex-col items-center justify-end py-20">
                                <h1 className="text-3xl md:text-5xl 4xl:text-8xl font-semibold mb-2 text-center ">Creativity is our hallmark</h1>
                                <h2 className="text-lg md:text-3xl 4xl:text-7xl font-thin text-center">We bring charms of both the worlds</h2>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex-1 flex flex-col relative bg-white items-center justify-center">
                <div className="flex z-20 absolute right-1/2 translate-x-1/2 top-0 -translate-y-1/2 max-w-7xl items-center justify-center md:space-x-1">
                    <Link href={"/interior-design"}>
                        <Button variant={"home"} className="rounded-r-full hover:shadow-2 4xl:text-3xl 4xl:p-8 !capitalize">
                            Architect & Interior
                        </Button>
                    </Link>
                ...
                <div className="flex items-center justify-center">
                    <Image src={"/images/new-homepage/PNG/L_Complete.png"} alt="Logo" height={500} width={800} className="w-1/2 4xl:w-5/6 object-cover" />
                </div>
            </div>
        </section>
    )
